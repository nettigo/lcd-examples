...
void analogMeter()
{
    ...
    plotNeedle(32, 0); // Put meter needle at 0
}
...
//    testSetup();
    ...
    delay(1000);
    tft.pushImage(80,200,NTG_NAPIS_WIDTH, NTG_NAPIS_HEIGHT, ntg_napis);
//    for (byte i=0;i<ntg_napisHeight;i++){
//    }
    delay(5000);
